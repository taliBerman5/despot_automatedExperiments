...
public:
    ...
    static std::tuple<std::vector<double>, std::vector<double>> Simulate(std::vector<State*>& particles,
...
protected:
    std::tuple<std::vector<double>,std::vector<double>> (*simulate_)(std::vector<State*>&, VNode*, const DSPOMDP*,
